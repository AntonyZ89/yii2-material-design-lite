    ...
    public function run()
    {
        ...
        $html = [
            Html::tag(
                ...
                [
                    'class' => 'mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--icon mdl-paging__prev',
            ...
            Html::tag(
                ...
                Html::icon('keyboard_arrow_right'),
                [
                    'class' => 'mdl-button mdl-js-button mdl-js-ripple-effect mdl-button--icon mdl-paging__next',
                    'data-page' => $currentPage + 1,
                    'href' => $this->pagination->createUrl($currentPage + 1)
                ]
            )
